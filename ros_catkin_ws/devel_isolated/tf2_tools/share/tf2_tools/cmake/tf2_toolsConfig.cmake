...
if("TRUE" STREQUAL "TRUE")
  set(tf2_tools_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/tf2/tf2_tools)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/tf2/tf2_tools/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/tf2_tools/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
