...
if("TRUE" STREQUAL "TRUE")
  set(bond_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/bondcpp/bond)
...
if(NOT "/home/pi/ros_catkin_ws/devel_isolated/bond/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bond' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/bondcpp/bond/${idir}'.  Ask the maintainer 'Mikael Arguedas <mikael@osrfoundation.org>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/bond/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
