...
if("TRUE" STREQUAL "TRUE")
  set(self_test_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/diagnostic_updater/self_test)
  set(self_test_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/self_test)
...
if(NOT "/home/pi/ros_catkin_ws/src/diagnostic_updater/self_test/include " STREQUAL " ")
  set(self_test_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/diagnostic_updater/self_test/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'self_test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/diagnostic_updater/self_test/${idir}'.  Ask the maintainer 'Brice Rebsamen <brice.rebsamen@gmail.com>, Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/self_test/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
