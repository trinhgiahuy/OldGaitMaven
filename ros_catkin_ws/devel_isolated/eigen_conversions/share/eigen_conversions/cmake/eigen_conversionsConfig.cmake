...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/tf/eigen_conversions)
...
if(NOT "/home/pi/ros_catkin_ws/src/tf/eigen_conversions/include;/opt/ros/kinetic/share/orocos_kdl/../../include;/usr/include/eigen3 " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/tf/eigen_conversions/include;/opt/ros/kinetic/share/orocos_kdl/../../include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/tf/eigen_conversions/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/opt/ros/kinetic/lib/liborocos-kdl.so.1.4.0")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/eigen_conversions/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
