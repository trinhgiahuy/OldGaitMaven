...
if("TRUE" STREQUAL "TRUE")
  set(test_diagnostic_aggregator_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/diagnostic_updater/test_diagnostic_aggregator)
  set(test_diagnostic_aggregator_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/test_diagnostic_aggregator)
  ...
  set(test_diagnostic_aggregator_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT "/home/pi/ros_catkin_ws/src/diagnostic_updater/test_diagnostic_aggregator/include " STREQUAL " ")
  set(test_diagnostic_aggregator_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/diagnostic_updater/test_diagnostic_aggregator/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test_diagnostic_aggregator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/diagnostic_updater/test_diagnostic_aggregator/${idir}'.  Ask the maintainer 'Brice Rebsamen <brice.rebsamen@gmail.com>, Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/test_diagnostic_aggregator/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
