...
if("TRUE" STREQUAL "TRUE")
  set(diagnostic_updater_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/diagnostic_updater/diagnostic_updater)
  set(diagnostic_updater_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/diagnostic_updater)
...
if(NOT "/home/pi/ros_catkin_ws/src/diagnostic_updater/diagnostic_updater/include " STREQUAL " ")
  set(diagnostic_updater_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/diagnostic_updater/diagnostic_updater/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'diagnostic_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/diagnostic_updater/diagnostic_updater/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>, Brice Rebsamen <brice.rebsamen@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/diagnostic_updater/lib;/home/pi/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
