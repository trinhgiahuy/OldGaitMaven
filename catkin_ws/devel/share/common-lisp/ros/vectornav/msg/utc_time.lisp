...
(cl:defmethod cl:initialize-instance :after ((m <utc_time>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'utc_time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vectornav-msg:<utc_time> is deprecated: use vectornav-msg:utc_time instead.")))

(cl:ensure-generic-function 'year-val :lambda-list '(m))
(cl:defmethod year-val ((m <utc_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:year-val is deprecated.  Use vectornav-msg:year instead.")
  (year m))

(cl:ensure-generic-function 'month-val :lambda-list '(m))
(cl:defmethod month-val ((m <utc_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:month-val is deprecated.  Use vectornav-msg:month instead.")
  (month m))

(cl:ensure-generic-function 'day-val :lambda-list '(m))
(cl:defmethod day-val ((m <utc_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:day-val is deprecated.  Use vectornav-msg:day instead.")
  (day m))

(cl:ensure-generic-function 'hour-val :lambda-list '(m))
(cl:defmethod hour-val ((m <utc_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:hour-val is deprecated.  Use vectornav-msg:hour instead.")
  (hour m))

(cl:ensure-generic-function 'minute-val :lambda-list '(m))
(cl:defmethod minute-val ((m <utc_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:minute-val is deprecated.  Use vectornav-msg:minute instead.")
  (minute m))

(cl:ensure-generic-function 'second-val :lambda-list '(m))
(cl:defmethod second-val ((m <utc_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:second-val is deprecated.  Use vectornav-msg:second instead.")
  (second m))

(cl:ensure-generic-function 'millisecond-val :lambda-list '(m))
(cl:defmethod millisecond-val ((m <utc_time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:millisecond-val is deprecated.  Use vectornav-msg:millisecond instead.")
  (millisecond m))
