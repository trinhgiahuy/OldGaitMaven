...
(cl:defclass <gps> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (UtcTime
    :reader UtcTime
    :initarg :UtcTime
    :type vectornav-msg:utc_time
    :initform (cl:make-instance 'vectornav-msg:utc_time))
   (Week
    :reader Week
    :initarg :Week
    :type cl:fixnum
