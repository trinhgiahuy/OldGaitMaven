...
(cl:defmethod SyncInTime-val ((m <ins>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:SyncInTime-val is deprecated.  Use vectornav-msg:SyncInTime instead.")
  (SyncInTime m))

(cl:ensure-generic-function 'SyncInCount-val :lambda-list '(m))
(cl:defmethod SyncInCount-val ((m <ins>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vectornav-msg:SyncInCount-val is deprecated.  Use vectornav-msg:SyncInCount instead.")
  (SyncInCount m))
