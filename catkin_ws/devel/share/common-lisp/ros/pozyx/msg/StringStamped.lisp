...
(cl:defmethod cl:initialize-instance :after ((m <StringStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pozyx-msg:<StringStamped> is deprecated: use pozyx-msg:StringStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <StringStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx-msg:header-val is deprecated.  Use pozyx-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <StringStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pozyx-msg:data-val is deprecated.  Use pozyx-msg:data instead.")
  (data m))
